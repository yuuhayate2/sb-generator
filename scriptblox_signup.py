      ...
      <div class="config-card">
        ...
        <div class="config-card-body" id="configBody">
          ...
          <div class="config-row">
            ...
            <div class="proxy-badge" id="proxyToggleBtn" onclick="toggleProxyPanel()" title="Click to edit proxies">
              <span id="proxyBadgeText">loading proxies...</span>
            </div>
          </div>
...
async function saveProxies() {
  ...
  try {
    ...
    if (data.ok) {
      ...
      document.getElementById('proxyBadgeText').textContent = data.count + ' proxies loaded';
      document.getElementById('proxyToggleBtn').classList.add('ok');
    } else {
...
function initSocket() {
  ...
  socket.on('info', d => {
    const badge = document.getElementById('proxyBadgeText');
    if (badge) badge.textContent = d.proxies + ' proxies loaded';
    if (d.proxies > 0) {
